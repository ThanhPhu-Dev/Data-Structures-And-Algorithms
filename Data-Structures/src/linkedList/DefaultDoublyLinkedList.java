...
public class DefaultDoublyLinkedList<T> implements DoublyLinkedList<T> {
    ...
    public T removeFirst() {
        if (isEmpty()) throw new RuntimeException("Empty linked list!");
        T data = head.getData();
        //nếu node tiếp theo là null thì head sẽ là null
        head = head.getNext();
        size--;
        //nếu empty thì set tail = null lun
        //ngược lại nếu không null thì head có thể dùng method setprev nên setPrev là null
